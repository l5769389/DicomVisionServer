...
class SeriesSummary(BaseModel):
    ...
    is_image_series: bool = Field(default=True, alias="isImageSeries")
    standard_object_type: str | None = Field(default=None, alias="standardObjectType")
    preferred_view_type: str | None = Field(default=None, alias="preferredViewType")
