...
class MprCrosshairOverlay:
    ...
    horizontal_slab_offset_x: float | None = None
    horizontal_slab_offset_y: float | None = None
    vertical_slab_offset_x: float | None = None
    vertical_slab_offset_y: float | None = None
...
class RenderContext:
    ...
    # A scalar is used for grayscale images. Colour images may provide one
    # value per channel so their padding follows the active colour LUT.
    background_cval: float | tuple[int, ...] = 0.0
