...
class PacsDimseDownloadJobService:
    ...
    def _get_job_locked(self, job_id: str, workspace_id: str | None = None) -> PacsDimseDownloadJob | None:
        job = self._jobs.get(job_id)
        if job is None:
            return None
    ...
    def _status_url(cls, job_id: str, workspace_id: str) -> str:
        return f"/api/v1/pacs/dimse/downloadSeries/jobs/{job_id}{cls._workspace_query(workspace_id)}"
