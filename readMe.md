...
2. 缩放
3. 调窗
4. 旋转，子项： 可以具体选择顺时针90、逆时针90、水平镜像、垂直镜像
5. 重置
6. 翻页
7. 标注
8. 测量， 子项：测量可以具体选择：线段、矩形、椭圆、角度
9. 播放，播放按钮启用后，切换为pause和end的按钮组，点击pause变为play、点击end还原为原来的状态。
10. 导出
11. 伪彩： 子项：可以选择具体的伪彩种类。
所有带子项的都以一个下拉框的方式呈现。选中子项后 操作栏的图标替换成子项内容。如果我点击操作栏的图标测表示该子项操作生效。

下拉框的按钮也垂直方向居中。把这些符号 icon 替换成真正统一的一套图标资源，这样视觉会更专业。
